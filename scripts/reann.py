...
atom2mass = {'H': 1.008, 'He': 4.003, 'Li': 6.941, 'Be': 9.012, 'B': 10.811, 'C': 12.017, 'N': 14.007, 'O': 15.999,
             ...
             'Cr': 51.996,
             'Mn': 54.938, 'Fe': 55.845, 'Co': 58.933, 'Ni': 58.693, 'Cu': 63.546, 'Zn': 65.409, 'Ga': 69.723,
             'Ge': 72.64,
             'As': 74.922, 'Se': 78.96, 'Br': 79.904, 'Kr': 83.798, 'Rb': 85.467, 'Sr': 87.62, 'Y': 88.906,
             'Zr': 91.224,
             'Nb': 92.907, 'Mo': 95.94, 'Tc': 97.907, 'Ru': 101.07, 'Rh': 102.905, 'Pd': 106.42, 'Ag': 107.868,
             'Cd': 112.411,
             'In': 114.818, 'Sn': 118.710, 'Sb': 121.760, 'Te': 127.60, 'I': 126.904, 'Xe': 131.293, 'Cs': 132.905,
             'Ba': 137.327,
             'La': 138.905, 'Ce': 140.116, 'Pr': 140.908, 'Nd': 144.242, 'Pm': 145, 'Sm': 150.36, 'Eu': 151.964,
             'Gd': 157.25,
             'Tb': 158.925, 'Dy': 162.500, 'Ho': 164.930, 'Er': 164.930, 'Tm': 168.934, 'Yb': 173.04, 'Lu': 174.967,
             'Hf': 178.49,
             'Ta': 180.948, 'W': 183.84, 'Re': 186.207, 'Os': 190.23, 'Ir': 192.217, 'Pt': 195.084, 'Au': 196.967,
             'Hg': 200.59,
             'Tl': 204.383, 'Pb': 207.2, 'Bi': 208.980, 'Po': 208.982, 'At': 209.987, 'Rn': 222.018, 'Fr': 223,
             'Ra': 226,
...
class REANN(Calculator):
    ...
    def transfer2eann(self, atoms):
        ...
        number_atom = []
        for sp in spe1:
            s = re.sub(r'\d+\.?\d*', ' ', sp).split()
            num_atom = re.sub(r'\D', " ", sp).split()
            if len(num_atom) == 0:
